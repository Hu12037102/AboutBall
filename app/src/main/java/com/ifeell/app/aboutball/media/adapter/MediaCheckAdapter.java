...
public class MediaCheckAdapter extends RecyclerView.Adapter<MediaCheckAdapter.ViewHolder> {
   ...
   //     GlideUtils.loadImage(mContext, mData.get(i).filePath, viewHolder.mIvItem);
        GlideManger.get().loadImage(viewHolder.itemView.getContext(), mData.get(i).filePath,R.mipmap.icon_image_background,R.mipmap.icon_image_background,viewHolder.mIvItem);
