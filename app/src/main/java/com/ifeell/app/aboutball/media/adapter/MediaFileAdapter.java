package com.ifeell.app.aboutball.media.adapter;
...
public class MediaFileAdapter extends RecyclerView.Adapter<MediaFileAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MediaFileAdapter.ViewHolder viewHolder, final int i) {
        ...
        //    GlideUtils.loadImage(mContext, R.mipmap.icon_camera, viewHolder.mIvData);
            GlideManger.get().loadImage(viewHolder.itemView.getContext(),  R.mipmap.icon_camera, R.mipmap.icon_camera, R.mipmap.icon_camera,viewHolder.mIvData);
          ...
          //  GlideUtils.loadImage(mContext, mData.get(i).filePath, viewHolder.mIvData);
            GlideManger.get().loadImage(viewHolder.itemView.getContext(),  mData.get(i).filePath, R.mipmap.icon_image_background, R.mipmap.icon_image_background,viewHolder.mIvData);
            ...
            if (mData.get(i).isVideo) {
                ...
                viewHolder.mTvDuration.setText(DataUtils.videoDuration(mData.get(i).videoDuration));
            } else {
                viewHolder.mRlVideo.setVisibility(View.GONE);
            }
