...
public class MediaFolderAdapter extends RecyclerView.Adapter<MediaFolderAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        if (mData.get(i).firstFilePath != null) {
            GlideManger.get().loadImage(viewHolder.itemView.getContext(),mData.get(i).firstFilePath,R.mipmap.icon_image_background,R.mipmap.icon_image_background,viewHolder.mIvLeft);
        }
