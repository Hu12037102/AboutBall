    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        if (mData.get(position).isVideo) {
         ...
         //   GlideUtils.loadImage(container.getContext(), mData.get(position).filePath, pTData,false);
            GlideManger.get().loadMediaImage(container.getContext(),mData.get(position).filePath,pTData,false);
            ...
            GlideManger.get().loadMediaImage(container.getContext(),mData.get(position).filePath,photoView,false);
